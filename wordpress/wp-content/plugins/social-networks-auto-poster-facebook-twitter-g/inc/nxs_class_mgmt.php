    ...
    class nxs_adminMgmt {        
        ...
        public function nxs_adminMenu() { wp_enqueue_script( 'postbox' );    
         ...
         // $this->page = add_menu_page( 'Social Networks Auto Poster', '-={SNAP}=-','manage_options','nxssnap',array( $this, 'showPage_dashboard' ), NXS_RELPATH.'/img/snap-icon.png');
          ...
          add_submenu_page( 'nxssnap',__( 'Accounts', 'social-networks-auto-poster-facebook-twitter-g' ), __( 'Accounts', 'social-networks-auto-poster-facebook-twitter-g' ), 'haveown_snap_accss', 'nxssnap', array( $this, 'showPage_accounts' )  );                         
          ...
          add_submenu_page( 'nxssnap',__( 'Query/Timeline', 'social-networks-auto-poster-facebook-twitter-g' ), __( 'Query/Timeline', 'social-networks-auto-poster-facebook-twitter-g' ), 'haveown_snap_accss', 'nxssnap-query', array( $this, 'showPage_query' )  );                         
          add_submenu_page( 'nxssnap',__( 'Reposter', 'social-networks-auto-poster-facebook-twitter-g' ), __( 'Reposter', 'social-networks-auto-poster-facebook-twitter-g' ), 'manage_options', 'nxssnap-reposter', array( $this, 'showPage_reposter' )  );                                   
          add_submenu_page( 'nxssnap',__( 'Settings', 'social-networks-auto-poster-facebook-twitter-g' ), __( 'Settings', 'social-networks-auto-poster-facebook-twitter-g' ), 'manage_options', 'nxssnap-settings', array( $this, 'showPage_settings' )  );                         
          add_submenu_page( 'nxssnap',__( 'Log/History', 'social-networks-auto-poster-facebook-twitter-g' ), __( 'Log/History', 'social-networks-auto-poster-facebook-twitter-g' ), 'haveown_snap_accss', 'nxs-log', array( $this, 'showPage_log' )  );                        
          add_submenu_page( 'nxssnap',__( 'Help/Support', 'social-networks-auto-poster-facebook-twitter-g' ), __( 'Help/Support', 'social-networks-auto-poster-facebook-twitter-g' ), 'manage_options', 'nxs-help', array( $this, 'showPage_about' )  );    
        }            
        ...
        public function showPage_reposter() {  if (!empty($_GET['item'])) $post = get_post(intval($_GET['item'])); else $post = null;
            ...
            elseif (!empty($_GET['action'])&& $_GET['action']=='delete' && !empty($_GET['item']) && !empty($post) ) {
