...
<?php if($showPrices): ?>
            <h3 class="col-xs-10 col-sm-3 col-xs-push-10- col-sm-push-4 sln-steps-price sln-service-price">
...
<?php if($showPrices): ?>
            <h3 class="col-xs-10 col-sm-3 col-xs-push-10- col-sm-push-0 sln-steps-price sln-service-price">
                <?php echo $plugin->format()->moneyFormatted($service->getPrice())?>
                <!-- .sln-service-price // END -->
            </h3>
<?php endif ?>
